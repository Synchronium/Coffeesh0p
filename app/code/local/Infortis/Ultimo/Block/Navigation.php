...
class Infortis_Ultimo_Block_Navigation extends Mage_Core_Block_Template
{
    ...
    public function getCategoryUrl($category)
    {
        ...
        public function getCategoryNavigationTitle($category)
    {

        if ($category instanceof Mage_Catalog_Model_Category) {
            $name = $category->getName();
            $navigation_title = $category->getNavigationTitle();
           
        } else {
            $name = $this->_getCategoryInstance()
                ->setData($category->getData())
                ->getName();
            $navigation_title = $this->_getCategoryInstance()
                ->setData($category->getData())
                ->getNavigationTitle();
            
        }
				if ( strlen($navigation_title) > 0 ) {
...
//		}
        ...
        $html[] = '<span>' . $this->escapeHtml($this->getCategoryNavigationTitle($category)) . '</span>';
        $html[] = '</a>';
    ...
    public function drawOpenCategoryItem($category) {
        ...
        $html.= '>'."\n";
        $html.= '<a href="'.$this->getCategoryUrl($category).'"><span>'.$this->htmlEscape($this->getCategoryNavigationTitle($category)).'</span></a>'."\n";
