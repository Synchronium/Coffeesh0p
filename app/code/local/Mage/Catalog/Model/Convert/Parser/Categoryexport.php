    ...
    public function unparse()
    {
					...
					if($this->getVar('rootids')!="") {
				    	...
				    	foreach ($categories as $_categorytop) {
							  ...
							  #echo "CATID: " . $_categorytop->getId();
								...
								$row['bottom_description'] = $_categorytop->getBottomDescription();
								$row['navigation_title'] = $_categorytop->getNavigationTitle();
								...
								$batchExport = $this->getBatchExportModel()
										...
										#{
											if($subcategories->getId() > 0) {
												...
												$row3['bottom_description'] =  $_sub_category->getBottomDescription();
												$row3['navigation_title'] =  $_sub_category->getNavigationTitle();
												...
												$batchExport = $this->getBatchExportModel()
													...
													$row4['bottom_description'] = $_sub_sub_category->getBottomDescription();
													$row4['navigation_title'] = $_sub_sub_category->getNavigationTitle();			
																...
																$batchExport = $this->getBatchExportModel()
																	...
																	$row5['bottom_description'] = $_sub_sub_sub_category->getBottomDescription();
																	$row5['navigation_title'] = $_sub_sub_sub_category->getNavigationTitle();
																				...
																				$batchExport = $this->getBatchExportModel()
																						...
																						$row6['bottom_description'] = $_sub_sub_sub_sub_sub_category->getBottomDescription();
																						$row6['navigation_title'] = $_sub_sub_sub_sub_category->getNavigationTitle();
					...
					foreach ($subcats as $_category)
					{
						...
						#{
							...
							$row2['bottom_description'] = $_category->getBottomDescription();
							$row2['navigation_title'] = $_category->getNavigationTitle();
																  ...
																  /* START OF 5th LEVEL CATEGORY EXPORT */
																	...
																	foreach(explode(',',$subsubsubsubcategories) as $subsubsubsubcategoriesid)
																	{
																		if($subsubsubsubcategoriesid > 0) {
																			...
																			$row6['custom_use_parent_settings'] = $_sub_sub_sub_sub_category->getCustomUseParentSettings();
																			$row6['position'] = $_sub_sub_sub_sub_category->getPosition();
																	$row6['bottom_description'] = $_sub_sub_sub_sub_category->getBottomDescription();
																	$row6['navigation_title'] = $_sub_sub_sub_sub_category->getNavigationTitle();
																			$batchExport = $this->getBatchExportModel()
																					->setId(null)
																					->setBatchId($this->getBatchModel()->getId())
																					...
																					$row7['bottom_description'] = $_sub_sub_sub_sub_sub_category->getBottomDescription();
																					$row7['navigation_title'] = $_sub_sub_sub_sub_sub_category->getNavigationTitle();
																							$batchExport = $this->getBatchExportModel()
																									->setId(null)
																									->setBatchId($this->getBatchModel()->getId())
																									->setBatchData($row7)
